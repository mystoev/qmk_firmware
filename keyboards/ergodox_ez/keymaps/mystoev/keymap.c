 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |TO(1) |BL_TOGG| Alt | Ctrl/Left| Gui/Right|                               |Gui/Up|Ctrl/Down|Alt/[|  ] | TO(1)  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  TO(1),      BL_TOGG, LALT(KC_NO), LCTL_T(KC_LEFT), LGUI_T(KC_RGHT),                                             RGUI_T(KC_UP), RCTL_T(KC_DOWN), RALT_T(KC_LBRC), KC_RBRC, TO(1),
